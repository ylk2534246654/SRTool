...
public class ModActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Build.VERSION.SDK_INT>=23){
            ...
            {//有悬浮窗权限开启服务绑定 绑定权限
                ...
                try{
                    //没有权限
                    Toast.makeText(ModActivity.this, "当前无权限，请授权！", Toast.LENGTH_SHORT).show();
    ...
    private void createToucher() {
        ...
        if(intent.ACTION_VIEW.equals(action)){
            Toast.makeText(this, "正在解析Mod...", Toast.LENGTH_SHORT).show();
            new Thread(new Runnable() {
                @Override
                public void run() {
                    try {
                        String path = UriToPathUtil.getFilePathFromURI(ModActivity.this, intent.getData());
                        //Log.e("接收","uri："+path);
    ...
    private final Handler handler_mod= new Handler() {
        ...
        public void handleMessage(final Message msg) {
            ...
            //初始化
            LayoutInflater layoutInflater = LayoutInflater.from(ModActivity.this);
            //dialog_view
            ...
            try {
                if(path.indexOf(".srmod")!=-1){
                    String data = FileUtil.readZipFile(path,"README.md");
                    if(data==null || data.equals("null") || data.equals("") || data==""){
                        InputStreamReader inputReader = new InputStreamReader( getResources().getAssets().open("README.md") );
                ...
                e.printStackTrace();
                Intent intent_activity = new Intent(ModActivity.this, MainPoint.class);
                startActivity(intent_activity);
                return;
            }
            Markwon markwon = Markwon.builder(ModActivity.this)
                    .usePlugin(HtmlPlugin.create())//HTML
                    .usePlugin(ImagesPlugin.create(ModActivity.this))//内核
                    .build();
