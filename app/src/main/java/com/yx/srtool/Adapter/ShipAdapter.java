...
public class ShipAdapter extends RecyclerView.Adapter<ShipAdapter.eiewHolder>
{
	private Context mContext;
	private List<Bean> mDatas;
	public ShipAdapter(Context context, List<Bean> datas){
		mContext=context;
		mDatas=datas;
	}
	...
	private ShipAdapter.onHistoryClick onClick;
	//onclick
